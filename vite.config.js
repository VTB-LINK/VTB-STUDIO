...
export default defineConfig({
    ...
    server: {
        ...
        proxy: {
            "/remoteorign": {
                target: "https://as-archive-load-balance.kzmidc.workers.dev/Normalized%20Audio%20New/",
                changeOrigin: true,
                secure: true,
                rewrite: (p) => p.replace(/^\/remoteorign/, ""),
            },
            "/remotetuned": {
                target: "https://as-archive-load-balance.kzmidc.workers.dev/Normalized%20Audio%20New/%E4%BF%AE%E5%A4%8D%E6%96%87%E7%89%A9",
                changeOrigin: true,
                secure: true,
